...
TOP_K = 3 # reduce probability to provide non sense text, lower, more conservative; default, 40
...
K_RESULTS = 10 # number of answwer from chroma that will be prepend to query
